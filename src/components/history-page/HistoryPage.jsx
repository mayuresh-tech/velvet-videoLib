...
const HistoryPage = () => {
  ...
  const [clearFullHistorySuccess, setClearFullHistorySuccess] = useState(false);
  ...
  const clearFullHistory = () => {
    if ("login" in localStorage) {
      ...
      try {
        ...
        setClearFullHistorySuccess(true);
      } catch (e) {
        console.log(e);
      }
    } else {
  ...
  const callClearFullHistorySuccessFunc = () => {
    return (
      <div className="toast-box toast-success">
        <p>Full History Cleared!</p>
  ...
  useEffect(() => {
    ...
    setTimeout(() => setClearFullHistorySuccess(false), 5000);
  }, [loginError, clearFullHistorySuccess]);

  return (
    <>
      {loginError ? callLoginErrorFunc() : null}
      {clearFullHistorySuccess ? callClearFullHistorySuccessFunc() : null}
