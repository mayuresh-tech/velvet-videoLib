...
import "./MyPlaylistBox.css";

const MyPlaylistBox = ({ item }) => {
  ...
  return (
    <div className="playlist-box">
      <div
        onClick={() => {
          navigate("/playlistdetails", { state: item });
        }}
      >
        <p className="playlist-name">{item.playlistName}</p>
        <p className="playlist-videos">{item.playlistVideoCount} videos</p>
      </div>
      <div>
        <button
          onClick={() => {
            deleteUserPlaylist(item._id);
          }}
        >
